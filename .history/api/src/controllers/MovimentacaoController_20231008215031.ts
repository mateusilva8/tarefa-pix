...
export class MovimentacaoController {
  ...
  async create (req: Request, res: Response): Promise<Response>  {
    ...
    let cdItem: Cd_Item | null = await Cd_Item.findOneBy({itens_idItem: body.itens_idItem, cds_idCd: body.cds_idCd});
    ...
    if (body.tipo == 'E') {
        ...
        return res.status(422).json({error: 'Quantide indisponivel!'});
    }
